                ...
                <div class="card" id="desc">
                    <blockquote class="blockquote">
                        <p><svg class="bi" width="24" height="24">
                            ...
                            ဝမ်းနည်းပါတယ်။ မိတ်ဆွေရှာဖွေနေသာ လိပ်စာအချက်အလက်ကို ရှာမတွေ့ပါ။ ရှာဖွေနေသော မြို့နယ်နှင့်လမ်း
                            အနီးတွင်ရှိသော လိပ်စာများကို အောက်တွင်ဖော်ပြလိုက်ပါသည်။<u> မြေပုံတွင်ကြည့်ရန် </u> ခလုတ်ကိုနှိပ်ကာ ထို
                            လိပ်စာကို ကြည့်ရှူနိုင်ပါသည်။
                        </p>
                    </blockquote>
                </div>
            @else
                <div class="card" id="desc">
                    <blockquote class="blockquote">
                        <p><svg class="bi" width="24" height="24">
                            ...
                            လူကြီးမင်း ရှာဖွေနေသော လိပ်စာအချက်အလက်ကို တွေ့ရှိပါသည်။ <u> မြေပုံတွင်ကြည့်ရန် </u>
                            ခလုတ်လေးကိုနှိပ်ကာ ထိုလိပ်စာကို မြေပုံတွင်ကြည့်ရှုနိုင်ပါသည်။</p>
                    </blockquote>
                </div>
            @endif
        </div>
                    ...
                    @foreach ($result as $r_data)
                        @if ($info['similar'] ?? '')
                            @php
                                ...
                                $google = 'https://www.google.com/maps/search/' . $r_data->Longitude . 'E,' . $r_data->Latitude . 'N';
                            @endphp
                            ...
                            <tr>
                                ...
                                <td> <button type="button" class="btn btn-light"><a href='{{ $google }}'
                                            target="_blank">
